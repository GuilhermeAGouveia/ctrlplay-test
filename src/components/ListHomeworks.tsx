    ...
    render() {
        return (
            <ListSchContainer active={this.state.isActive}>
                ...
                <FilterContainer>
                    <InputFilter value={this.state.filterSelect}
                                 onChange={e => this.setState({filterSelect: e.target.value})}/>
                    <ButtonFilter type={'submit'}
                                  onClick={() => this.setState(state => ({homeworksFilter: state.homeworks.filter(h => h.subject.toLowerCase().includes(state.filterSelect.toLowerCase()))}))}>Filtrar</ButtonFilter>
                </FilterContainer>
            </ListSchContainer>
        )
    }
